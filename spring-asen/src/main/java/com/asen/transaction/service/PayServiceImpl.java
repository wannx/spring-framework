//package com.asen.transaction.service;
//
//import com.asen.transaction.dao.AccountInfoDao;
//import com.asen.transaction.dao.ProductInfoDao;
...
//		//查询余额
//		double blance = accountInfoDao.getBlanceByUserId(accountId);
//
//		//余额不足正常逻辑
